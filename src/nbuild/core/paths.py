...
def init(nbuildir, distdir, rootdir, blddir, rdir, ardir, srdir, sdir, cdir):
    ...
    _cbdir = pathlib.Path(nbuildir) / "nbuild"
...
def prepare():
    ...
    (nbuild_cache() / "apk").mkdir(parents=True, exist_ok=True)
